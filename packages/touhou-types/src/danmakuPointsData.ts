...
export const DANMAKU_POINTS_DATABASE: DanmakuPointsData[] = [
  ...
  { game: TouhouGame.TH08, shotType: 'Border Team (A)', lnn: 200, lnbPlus: 28, lnb: 28, l1cc: 17 },
  { game: TouhouGame.TH08, shotType: 'Magic Team (A)', lnn: 230, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Scarlet Team (A)', lnn: 240, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Ghost Team (A)', lnn: 210, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Reimu (A)', lnn: 420, lnbPlus: 33, lnb: 33, l1cc: 22 },
  { game: TouhouGame.TH08, shotType: 'Yukari (A)', lnn: 210, lnbPlus: 30, lnb: 30, l1cc: 19 },
  { game: TouhouGame.TH08, shotType: 'Marisa (A)', lnn: 310, lnbPlus: 31, lnb: 31, l1cc: 20 },
  { game: TouhouGame.TH08, shotType: 'Alice (A)', lnn: 380, lnbPlus: 35, lnb: 35, l1cc: 24 },
  { game: TouhouGame.TH08, shotType: 'Sakuya (A)', lnn: 550, lnbPlus: 35, lnb: 35, l1cc: 24 },
  { game: TouhouGame.TH08, shotType: 'Remilia (A)', lnn: 240, lnbPlus: 31, lnb: 31, l1cc: 20 },
  { game: TouhouGame.TH08, shotType: 'Youmu (A)', lnn: 200, lnbPlus: 28, lnb: 28, l1cc: 17 },
  { game: TouhouGame.TH08, shotType: 'Yuyuko (A)', lnn: 320, lnbPlus: 32, lnb: 32, l1cc: 21 },

  // TH08 - Imperishable Night (Final B)
  { game: TouhouGame.TH08, shotType: 'Border Team (B)', lnn: 210, lnbPlus: 28, lnb: 28, l1cc: 17 },
  { game: TouhouGame.TH08, shotType: 'Magic Team (B)', lnn: 230, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Scarlet Team (B)', lnn: 240, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Ghost Team (B)', lnn: 220, lnbPlus: 29, lnb: 29, l1cc: 18 },
  { game: TouhouGame.TH08, shotType: 'Reimu (B)', lnn: 430, lnbPlus: 33, lnb: 33, l1cc: 22 },
  { game: TouhouGame.TH08, shotType: 'Yukari (B)', lnn: 220, lnbPlus: 30, lnb: 30, l1cc: 19 },
  { game: TouhouGame.TH08, shotType: 'Marisa (B)', lnn: 340, lnbPlus: 31, lnb: 31, l1cc: 20 },
  { game: TouhouGame.TH08, shotType: 'Alice (B)', lnn: 400, lnbPlus: 36, lnb: 36, l1cc: 25 },
  { game: TouhouGame.TH08, shotType: 'Sakuya (B)', lnn: 500, lnbPlus: 36, lnb: 36, l1cc: 25 },
  { game: TouhouGame.TH08, shotType: 'Remilia (B)', lnn: 250, lnbPlus: 31, lnb: 31, l1cc: 20 },
  { game: TouhouGame.TH08, shotType: 'Youmu (B)', lnn: 210, lnbPlus: 28, lnb: 28, l1cc: 17 },
  { game: TouhouGame.TH08, shotType: 'Yuyuko (B)', lnn: 320, lnbPlus: 32, lnb: 32, l1cc: 21 },
